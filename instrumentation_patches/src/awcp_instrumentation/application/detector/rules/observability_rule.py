...
_HOOK = GovernanceHook(
    ...
    name="HookType.STEP",
    description="AWCP observability hook: emitted at key checkpoints to expose intermediate agent state via HookType.STEP",
    signature="get_manager().dispatch(HookType.STEP, agent_id=agent_id, task_id=task_id, checkpoint=checkpoint_name)",
    line_number=None,
)
