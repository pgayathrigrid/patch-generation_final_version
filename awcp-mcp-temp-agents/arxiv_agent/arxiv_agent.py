...
def run_goal(goal: str) -> dict:
    get_manager().dispatch(HookType.TOKEN_USAGE, agent_id="agent", task_id=None)
    get_manager().dispatch(HookType.BUDGET_WARN, agent_id="agent", task_id=None)
    get_manager().dispatch(HookType.TASK_COMPLETED, agent_id="arXiv Research Worker", task_id=None)
    get_manager().dispatch(HookType.TASK_STARTED, agent_id="agent", task_id=None)
    get_manager().dispatch(HookType.BUDGET_EXHAUSTED, agent_id="arXiv Research Worker", task_id=None, used_ratio=1.0)
    get_manager().dispatch(HookType.LLM_CALL, agent_id="arXiv Research Worker", task_id=None, model=MODEL)
    get_manager().dispatch(HookType.TASK_FAILED, agent_id="arXiv Research Worker", task_id=None, error=None)
